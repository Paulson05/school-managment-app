...
<head>
    ...
    <script src="../../cdn-cgi/apps/head/OkbNSnEV_PNHTKP2_EYPrFNyZ8Q.js"></script><link rel="stylesheet" href="{{asset('frontend/css/bootstrap.min.css')}}">
        ...
        <div class="row">
            <div class="col-xs-6 col-sm-8 col-md-9">
                <div class="header-top_address">
                    ...
                    <div class="header-top_list">
                        <span class="icon-envelope-open"></span><a href="https://demo.web3canvas.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="066f6860694673686f7565692865696b">[email&#160;protected]</a>
                    </div>
                    <div class="header-top_list">
                        <span class="icon-location-pin"></span>Albany, NY, USA. 11001
                    </div>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="address">
                    ...
                    <p>Email : <a href="https://demo.web3canvas.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="553c3b333a15203b3c26363a7b363a38">[email&#160;protected]</a>
...
<script src="{{asset('frontend/js/validate.j')}}s"></script>
<script src="{{asset('frontend/js/tweetie.min.js')}}"></script>

<script src="{{asset('frontend/js/subscribe.js')}}"></script>
