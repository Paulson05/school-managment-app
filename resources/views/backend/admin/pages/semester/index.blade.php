                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="card">
                                                ...
                                                <form class="form theme-form" action="{{route('semester.store')}}" method="post">
                                                    @csrf
                                                    <div class="card-body">
                                                        <div class="row">
                                                            <div class="col-xs-12 col-sm-6 col-md-12">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input class="form-control" id="exampleFormControlInput1" name="term" type="text" placeholder="level">
                                                                </div>
                                                            </div>
                                                            <div class="text-left">
