<!DOCTYPE html>
<html lang="en">
<!-- Mirrored from admin.pixelstrap.com/cuba/theme/general-widget.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 02 Sep 2021 18:25:19 GMT -->
<head>
    @include('backend.user.template.partials.head')
</head>
<body>
<!-- tap on top starts-->
...
<div class="page-wrapper compact-wrapper" id="pageWrapper">
    ...
    <div class="page-body-wrapper">
        <!-- Page Sidebar Start-->
        @include('backend.user.template.partials.sidenavbar')
        <!-- Page Sidebar Ends-->
        <div class="page-body">
           @yield('body')
        ...
        <!-- footer start-->
        @include('backend.user.template.partials.footer')
    </div>
</div>
@include('backend.user.template.partials.scripts')
<!-- login js-->
<!-- Plugin used-->
</body>

<!-- Mirrored from admin.pixelstrap.com/cuba/theme/general-widget.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 02 Sep 2021 18:25:26 GMT -->
